...
const { medical_report, patient, admin, chemist, phone, diseases, patient_has_diseases, contract, lab_contracts_doctor, bill, financial_transaction, payment_method, packages_and_offers, employee, branch, test} = require("../models");
