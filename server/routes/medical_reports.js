...
router.get(
  ...
  async (req, res) => {
    try {
      // Optimized query: Use subqueries for counts instead of separate queries or eager loading arrays
      // This avoids the N+1 problem and fetching all IDs initially
