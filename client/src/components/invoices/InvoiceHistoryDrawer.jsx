...
<<<<<<< HEAD
                  ...
                  {index < history.length - 1 && <div className="timeline-line bg-light flex-grow-1" style={{ width: '2px' }}></div>}
                </div>
                <div className="timeline-content pb-4 flex-grow-1 border-bottom">
                  <div className="d-flex justify-content-between align-items-start mb-1">
                    <h6 className="mb-0 fw-bold">{event.type}</h6>
                    <span className="small text-muted">{formatDate(new Date(event.date))}</span>
                  </div>
                  <p className="mb-2 text-dark">{event.details}</p>
                  
                  <div className="d-flex flex-wrap gap-2 align-items-center">
                    <Badge bg="light" className="text-dark border font-weight-normal">
                      By: {event.user}
                    </Badge>
