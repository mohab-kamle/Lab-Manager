...
const ChemistDashboard = React.lazy(() =>
  import("./pages/chemist/ChemistDashboard")
);
...
const PatientsAdminView = React.lazy(() =>
  import("./pages/admin/PatientsAdminView")
);
const PatientsAnalytics = React.lazy(() =>
  import("./pages/admin/PatientsAnalytics")
);
const PatientProfile = React.lazy(() =>
  import("./pages/patient/PatientProfile")
);
const PatientUpdateProfile = React.lazy(() =>
  import("./pages/patient/PatientUpdateProfile")
);
const PatientReports = React.lazy(() =>
  import("./pages/reports/PatientReports")
);
const MedicalReports = React.lazy(() =>
  import("./pages/reports/MedicalReports")
);
...
const TestGroupEditor = React.lazy(() =>
  import("./pages/tests/TestGroupEditor")
);
const TestGroupComponents = React.lazy(() =>
  import("./pages/tests/TestGroupComponents")
);
const TestGroupCategories = React.lazy(() =>
  import("./pages/tests/TestGroupCategories")
);
...
const EmployeeManagement = React.lazy(() =>
  import("./pages/branches/EmployeeManagement")
);
const PaymentMethods = React.lazy(() =>
  import("./pages/invoices/PaymentMethods")
);
const PackagesAndOffers = React.lazy(() =>
  import("./pages/packages/PackagesAndOffers")
);
        ...
        <AnimatePresence mode="wait">
          <Routes location={location} key={location.pathname}>
            ...
            >
              ...
              />
              <Route
                path="admin/test-groups/:id/edit"
                element={
                  <PrivateRoute allowedRoles={["admin"]}>
                    <TestGroupEditor />
                  </PrivateRoute>
              ...
              />
              <Route
                path="admin/test-groups/:id/components"
                element={
                  <PrivateRoute allowedRoles={["admin"]}>
                    <TestGroupComponents />
                  </PrivateRoute>
              ...
              />
              <Route
                path="admin/test-group-categories"
                element={
                  <PrivateRoute allowedRoles={["admin"]}>
                    <TestGroupCategories />
                  </PrivateRoute>
              ...
              />
              <Route
                path="admin/test-group-components"
                element={
                  <PrivateRoute allowedRoles={["admin"]}>
                    <TestGroupComponents />
                  </PrivateRoute>
              ...
              />
              <Route
                path="chemist/test-groups/:id/edit"
                element={
                  <PrivateRoute allowedRoles={["chemist"]}>
                    <TestGroupEditor />
                  </PrivateRoute>
              ...
              />
              <Route
                path="chemist/test-groups/:id/components"
                element={
                  <PrivateRoute allowedRoles={["chemist"]}>
                    <TestGroupComponents />
                  </PrivateRoute>
              ...
              />
              <Route
                path="chemist/test-group-categories"
                element={
                  <PrivateRoute allowedRoles={["chemist"]}>
                    <TestGroupCategories />
                  </PrivateRoute>
              ...
              />
              <Route
                path="chemist/test-group-components"
                element={
                  <PrivateRoute allowedRoles={["chemist"]}>
                    <TestGroupComponents />
                  </PrivateRoute>
              ...
              />
              <Route
                path="receptionist/test-groups/:id/edit"
                element={
                  <PrivateRoute allowedRoles={["receptionist"]}>
                    <TestGroupEditor />
                  </PrivateRoute>
              ...
              />
              <Route
                path="receptionist/test-groups/:id/components"
                element={
                  <PrivateRoute allowedRoles={["receptionist"]}>
                    <TestGroupComponents />
                  </PrivateRoute>
              ...
              />
              <Route
                path="receptionist/test-group-categories"
                element={
                  <PrivateRoute allowedRoles={["receptionist"]}>
                    <TestGroupCategories />
                  </PrivateRoute>
              ...
              />
              <Route
                path="receptionist/test-group-components"
                element={
                  <PrivateRoute allowedRoles={["receptionist"]}>
                    <TestGroupComponents />
                  </PrivateRoute>
              ...
              <Route
                path="receptionist/medical-reports"
                element={
                  <PrivateRoute allowedRoles={["receptionist"]}>
                    <MedicalReports />
                  </PrivateRoute>
